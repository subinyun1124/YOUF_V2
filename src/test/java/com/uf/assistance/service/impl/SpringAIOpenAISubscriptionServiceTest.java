...
class SpringAIOpenAISubscriptionServiceTest {
    ...
    void testGetAvailableAIs() {
        ...
        // When
        List<AI> result = subscriptionService.getAvailableAIs();
    ...
    void testHasUserSubscribedAITrue() {
        // Given
        when(aiRepository.findById(1L)).thenReturn(Optional.of(testAI));
        when(aiSubscriptionRepository.existsByUserAndAi(any(User.class), eq(testAI))).thenReturn(true);
    ...
    void testHasUserSubscribedAIFalse() {
        // Given
        when(aiRepository.findById(1L)).thenReturn(Optional.of(testAI));
        when(aiSubscriptionRepository.existsByUserAndAi(any(User.class), eq(testAI))).thenReturn(false);
    ...
    void testSubscribeNew() {
        ...
        // When
        AISubscription result = subscriptionService.subscribe(1L, 1L);
    ...
    void testSubscribeInactiveAI() {
        ...
        when(aiSubscriptionRepository.existsByUserAndAi(any(User.class), eq(inactiveAI))).thenReturn(false);
