...
public class DynamicSchedulerService {
    ...
    public void scheduleJob(ScheduledJob job) throws SchedulerException {
        ...
        JobDetail jobDetail = JobBuilder.newJob(DynamicQuartzJob.class)
                .withIdentity(job.getJobName() + "_" + job.getUserId(), job.getJobGroup())
                .usingJobData(jobDataMap)
                .build();

        Trigger trigger = TriggerBuilder.newTrigger()
                .withIdentity(job.getJobName() + "_" + job.getUserId() + "_trigger", job.getJobGroup())
    ...
    public void triggerOneTimeJob(ScheduledJob job) throws SchedulerException {
        ...
        JobDetail jobDetail = JobBuilder.newJob(DynamicQuartzJob.class)
                .withIdentity(job.getJobName() + "_" + job.getUserId() +"_onetime", job.getJobGroup())
                .usingJobData(jobDataMap)
                .build();

        Trigger trigger = TriggerBuilder.newTrigger()
                .withIdentity(job.getJobName() + "_" + job.getUserId() + "_OneTime_Trigger", job.getJobGroup())
                .startNow()
                .build();
